...
#define DPRAM_BASE(a)                           ((volatile short*)DPRAM_CPU_base + (a))
#define DPRAM2_base(a)                          ((volatile short*)DPRAM_CPU_base + (a)) 

//0x5555, 0x6666, 0x8888, 0x7777, 0x0001, 0x0000, 0x0000, 0x0000, 0x000B, 0xB970, 0x0003, 0x0003, 0x0003, 0x0003, 0x0003, 0x0003, 
//0x0003, 0x0003, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
...
#define DP_SLOW_IDLE_DIVIDER                      DP_DSP_TASK_STATUS_BASE + 0x008 /* 0x3a08 -1:dis, 11:en*/
...
#define DP2_TX_GPRS_CONSTELLATION                 DP_LOGI_CHANNEL_BASE + 0x008 /* 0x3aee */
...
#define SPH_ENH_DL_GAIN                           DP2_SP_AUDIO_INTERFACE_CTRL_BASE + 0x003 /* 0x3d78 */
...
#define AUDIO_ASP_WAV_OUT_GAIN                    DP2_SP_AUDIO_INTERFACE_CTRL_BASE + 0x007 /* 0x3d7c PCM GAIN */
...
#define KEYTONE1_CTRL                             DP2_SP_KT_CTRL_BASE + 0x000 /* 0x3d88  state DSP_TONE_RUNING, DSP_TONE_STOP */
#define KEYTONE2_CTRL                             DP2_SP_KT_CTRL_BASE + 0x001 /* 0x3d89  state ... */
#define DP_ASP_FORCE_KT_8K                        DP2_SP_KT_CTRL_BASE + 0x002 /* 0x3d8a  AM_WriteAspParam() */
#define KEYTONE1_FREQ                             DP2_SP_KT_CTRL_BASE + 0x003 /* 0x3d8b  DSP_QTMF_FREQ() */
#define KEYTONE2_FREQ                             DP2_SP_KT_CTRL_BASE + 0x006 /* 0x3d8e  DSP_QTMF_FREQ() */
#define DP_KEYTONE_ATT_GAIN                       DP2_SP_KT_CTRL_BASE + 0x009 /* 0x3d91  =0, avoid SD buffer repeating if tone/keytone continues */
...
#define SPH_DM_ADDR_PNW_UL1_BUF                   DP2_SP_CTM_BASE + 0x000 /* 0x3e28 */
#define SPH_DM_ADDR_PNW_UL2_BUF                   DP2_SP_CTM_BASE + 0x001 /* 0x3e29 */
#define SPH_DM_ADDR_PNW_DL1_BUF                   DP2_SP_CTM_BASE + 0x002 /* 0x3e2a */
#define SPH_DM_ADDR_PNW_DL2_BUF                   DP2_SP_CTM_BASE + 0x003 /* 0x3e2b */
...
#define AUDIO_PP_ReserveA6                        DP2_AUDIO_PP_CTRL_BASE + 0x009 /* 0x3f31 */
#define AUDIO_PP_ReserveA7                        DP2_AUDIO_PP_CTRL_BASE + 0x00a /* 0x3f32 */
...
#define PCM_Rount_Data_Address                    DP2_AUDIO_PP_CTRL_BASE + 0x00e /* 0x3f36 */
#define PCM_Rount_Data_Length                     DP2_AUDIO_PP_CTRL_BASE + 0x00f /* 0x3f37 */
#define PCM_Rount_Data_Pagenum                    DP2_AUDIO_PP_CTRL_BASE + 0x010 /* 0x3f38 */
#define AUDIO_PP_ReserveC1                        DP2_AUDIO_PP_CTRL_BASE + 0x011 /* 0x3f39 */
...
#define SHERIF_SIZE                               1357



//=============================================================================================
//=============================================================================================
#define DSP_STATUS                          (*DPRAM_BASE( DP_DSP_STATUS ))
#define MCU_STATUS                          (*DPRAM_BASE( DP_MCU_STATUS ))
#define DSP_STATUS_MTCMOS                   (*DPRAM_BASE( DP_DSP_STATUS_MTCMOS )) 
#define MCU_STATUS_MTCMOS                   (*DPRAM_BASE( DP_MCU_STATUS_MTCMOS )) 
#define DSP_ROM_VERSION                     (*DPRAM_BASE( DP_DSP_ROM_VERSION ))


//============================================================================================================
// SHERIF BASE ADDRESS
//============================================================================================================
#define DP_SP_CODEC_CTRL_base(a)            (DPRAM2_base(DP2_SP_CODEC_CTRL_BASE)           +(a)) 
...
// AUDIO Tone Control
//=============================================================================================
#define DSP_TONE_CTRL1_AUD                  (*DP_AUDIO_PP_CTRL_base(0x11)) // =0, toneInit()
#define DSP_TONE_CTRL2_AUD                  (*DP_AUDIO_PP_CTRL_base(0x12)) // =0, toneInit()

//=============================================================================================
// Keytone & Tone
//=============================================================================================
#define DSP_TONE_CTRL1                      (*DPRAM_BASE(  KEYTONE1_CTRL) ) // state
#define DSP_TONE_CTRL2                      (*DPRAM_BASE(  KEYTONE2_CTRL) ) // state
#define DSP_TONE_F1A                        (*DPRAM_BASE(  KEYTONE1_FREQ))
#define DSP_TONE_F1B                        (*DPRAM_BASE( (KEYTONE1_FREQ + 1) ) )
#define DSP_TONE_AMP1                       (*DPRAM_BASE( (KEYTONE1_FREQ + 2) ) )
#define DSP_TONE_F2A                        (*DPRAM_BASE(  KEYTONE2_FREQ      ) )
#define DSP_TONE_F2B                        (*DPRAM_BASE( (KEYTONE2_FREQ + 1) ) )
#define DSP_TONE_AMP2                       (*DPRAM_BASE( (KEYTONE2_FREQ + 2) ) )
#define DSP_KT_ATT                          (*DPRAM_BASE( DP_KEYTONE_ATT_GAIN ) )  
#define DSP_TONE_FORCE_KT_8K                (*DPRAM_BASE( DP_ASP_FORCE_KT_8K  ) ) 
...
// 8K limiter control
//=============================================================================================
#define DSP_8K_LIMITER_CTRL             (*DPRAM_BASE(DP2_8k_SP_CTRL)) 
#define DSP_SCR_CTRL                    (*DPRAM_BASE(DP2_8k_SP_CTRL)) 
#define DSP_SP_AUDIO_INTERFACE_CTRL_base(a)   (DPRAM_BASE(DP2_SP_AUDIO_INTERFACE_CTRL_BASE) +(a))

//=============================================================================================
//                  SPEECH Control Filed
//=============================================================================================
#define DP_SC_FLAGS         *DPRAM2_base(DP_SC_ADDR)            
/* speech coder enabling flag [0]            */
...
#define DP_MARGIN_PCM_W     *DPRAM2_base(DP2_MARGIN_PCM_W)      
/* margin for the VBI PCM write [7:0]        */
/* SID detection threshold LOW [9:8]         */
/* SID detection threshold High [15:10]      */
#define DP_SC_MODE          *DPRAM2_base(DP2_SC_MODE)           
/* CODEC type for speech decoder [7:0]       */
/* CODEC type for speech coder [15:8]        */
#define DP_SC_VAD           *DPRAM2_base(DP2_SC_VAD)    /* VAD: FR, HR, EFR, AMR1m AMR2              */
#define DP_SC_MUTE          *DPRAM2_base(DP2_SC_MUTE)           
/* speech coder muting flag [0]              */
/* speech decoder muting flag [1]            */
/* Nsync reset mode [4]                      */
/* Nsync followed by ETSI/Stepmind [5]       */
/* Nsync reset value only used in MCU [15:8] */
#define DP_SC_EVLUATE_DELAY *DPRAM2_base(SPH_DEL_O) /* DSP evaluate speech delay offset while MCU extend frame  */                                                                   
...
#define DSP_PCM_DGAIN                       *DPRAM2_base(AUDIO_ASP_WAV_OUT_GAIN)    
